...
func TestMigrationsRunner_AuthIdentitySchemaStaysAlignedAndPaymentTablesAreRemoved(t *testing.T) {
	tx := testTx(t)
	...
	require.Nil(t, paymentOrdersRegclass)
}
