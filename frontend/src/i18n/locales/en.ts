export default {
  ...
  imageGenerate: {
    ...
    referenceHint: 'PNG, JPEG, or WebP up to 20 MB',
    referenceImagePreview: 'Reference image preview',
    replaceReference: 'Replace',
    removeReference: 'Remove reference image',
    referenceTypeError: 'Reference image must be PNG, JPEG, or WebP',
    referenceSizeError: 'Reference image must be 20 MB or smaller',
    model: 'Model',
    size: 'Size',
    quality: 'Quality',
    count: 'Count',
    ...
    queued: 'Queued',
    running: 'Generating',
    jobAccepted: 'Image job submitted. The result will appear automatically.',
    creatingJob: 'Submitting image job',
    creatingJobHint: 'Connecting to the service and creating the job.',
    loadingResult: 'Image generated, loading result',
    loadingResultHint: 'Downloading the original image and preparing its preview.',
    loadJobsFailed: 'Failed to load image jobs',
    resultLoadFailed: 'The image was generated, but the result could not be loaded',
    results: 'Results',
  ...
  keys: {
    ...
    secretDialogTitle: 'API key created',
    secretDialogWarning: 'Keep this key secure. You can copy it again from the API keys list after closing.',
    secretDialogSaved: 'Close',
    ...
    customKeyPlaceholder: 'Enter your custom key (min 32 chars)',
    customKeyHint: 'Only letters, numbers, underscores and hyphens allowed. Minimum 32 characters.',
    customKeyTooShort: 'Custom key must be at least 32 characters',
  ...
  admin: {
    ...
    accounts: {
      ...
      dataExportPassword: 'Current admin password',
      dataExportPasswordRequired: 'Enter your current admin password',
      ...
      fallbackModelHint: 'Used when the requested model does not match any configured model mapping or wildcard.',
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        rewriteMessageCacheControlHint: 'Default off preserves client breakpoints; when a request has no message breakpoints, the proxy adds stable ones automatically. When enabled, client breakpoints are stripped and proxy breakpoints are injected.',
      ...
      balanceNotify: {
        ...
        thresholdPlaceholder: 'Enter amount',
        rechargeUrl: 'Redeem Page URL',
        rechargeUrlPlaceholder: 'https://example.com/redeem',
        rechargeUrlHint: 'A redeem button will appear in the email when set',
      },
      quotaNotify: {
  ...
  onboarding: {
    ...
    admin: {
      ...
      createKey: {
        title: '➕ Create Key',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Click the button to create your first API Key.</p><p style="padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Tip:</b> You can copy the key later from the API keys list</p><p style="margin-top: 12px; color: #10b981; font-weight: 600;">👉 Click "Create Key" button</p></div>'
      },
      keyName: {
        title: '✏️ 1. Key Name',
    ...
    user: {
      ...
      createKey: {
        ...
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Click the button to create your first API key.</p><p style="padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Tip:</b> You can copy the key later from the API keys list</p><p style="margin-top: 12px; color: #10b981; font-weight: 600;">👉 Click "Create Key"</p></div>'
      },
      keyName: {
        title: '✏️ Key Name',
      ...
      keySubmit: {
        ...
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Click to confirm and create your API key.</p><div style="padding: 8px 12px; background: #fee2e2; border-left: 3px solid #ef4444; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>⚠️ Important:</b><ul style="margin: 8px 0 0 16px;"><li>You can copy the key (sk-xxx) from the API keys list</li><li>Keep it secure and do not share it</li></ul></div><p style="padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>🚀 How to Use:</b><br/>Configure the key in any OpenAI-compatible client (like ChatBox, OpenCat, etc.) and start using!</p><p style="margin-top: 12px; color: #10b981; font-weight: 600;">👉 Click "Create" button</p></div>'
      }
    }
  },
