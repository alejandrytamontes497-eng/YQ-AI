<template>
  <div class="card overflow-hidden">
    <table class="w-full table-fixed border-collapse text-sm">
      ...
      <!-- Render one tbody per channel so rowspans keep channel metadata aligned. -->
      <tbody
        v-else
      ...
      >
        ...
        >
          <!-- Channel name spans platform rows. -->
          <td
            v-if="secIdx === 0"
          ...
          <!-- Description spans platform rows. -->
          <td
            v-if="secIdx === 0"
            :rowspan="channel.platforms.length"
          ...
          <!-- Exclusive groups are listed before public groups. -->
          <td class="align-top px-4 py-3">
